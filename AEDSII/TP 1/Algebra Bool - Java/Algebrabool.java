...
class Main {
    // FunÃ§Ã£o para substituir letras de acordo com o valor de n
    ...
    // FunÃ§Ã£o para resolver a expressÃ£o atÃ© que reste apenas um resultado
    ...
    // FunÃ§Ã£o para remover espaÃ§os em branco
    ...
    // FunÃ§Ã£o para resolver operaÃ§Ã£o lÃ³gica 'and'
    static String and(String s2) {
        ...
        for (int i = 0; i < tam; i++) {
            ...
            } else if (temp == 'a' && s2.charAt(i + 1) == 'n' && s2.charAt(i + 2) == 'd' && s2.charAt(i + 3) == '('
                    && (s2.charAt(i + 4) == '1' || s2.charAt(i + 4) == '0')
    ...
    // FunÃ§Ã£o para resolver operaÃ§Ã£o lÃ³gica 'or'
    ...
    // FunÃ§Ã£o para resolver operaÃ§Ã£o lÃ³gica 'not'
    ...
    // FunÃ§Ã£o para verificar o resultado da expressÃ£o
    ...
    public static void main(String args[]) {
        ...
        while (status) {
            ...
            // LÃª a expressÃ£o lÃ³gica
            String s = scanner.nextLine();

            // Verifica o resultado da expressÃ£o e imprime 0 ou 1
